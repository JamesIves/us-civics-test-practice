  ...
  <footer className="footer container">
    <div className="footer__left">
      <span>
        ...
        . This page is in no way affiliated with the United States goverment. Icons provided by Twitter/Twemoji.          <a href="https://jives.dev/us-civics-test-practice">Restart Test?</a>
      </span>
    </div>
